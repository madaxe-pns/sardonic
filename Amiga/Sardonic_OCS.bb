...
#COPPERPROFJ = $6 ; 3+3 BitPlanes = 8+8 Cores - Jogo (Dual PlayField)
#COPPERPROFM = $5 ; 5 BitPlanes = 32 Cores - Menu
#PROF = 5  ; 5 BitPlanes = 32 cores
#CORES = 32 ; 32 Cores
#BITPLANES = 3
...
#CORPLANETA = 15 ; Index da Cor do Planeta
#CORSATURNO = 12 ; Index da Cor do Saturno


#CORNV1 = 17 ; Index da Cor 1 da Nave
#CORNV2 = 19 ; Index da Cor 2 da Nave

#RGBNV11 = 14 ; RGB 1 da Cor 1 da Nave
#RGBNV12 = 14 ; RGB 2 da Cor 1 da Nave
#RGBNV13 = 8  ; RGB 3 da Cor 1 da Nave

#RGBNV21 = 8  ; RGB 1 da Cor 2 da Nave
#RGBNV22 = 2  ; RGB 2 da Cor 2 da Nave
...
#CORBOSS5 = 7 ; Index da Cor 1 do Boss 5

#RGBBOSS11 = 2  ; RGB 1 da Cor 1 do Boss 1
#RGBBOSS12 = 10 ; RGB 2 da Cor 1 do Boss 1
#RGBBOSS13 = 12 ; RGB 3 da Cor 1 do Boss 1

#RGBBOSS21 = 4  ; RGB 1 da Cor 1 do Boss 2
#RGBBOSS22 = 10 ; RGB 2 da Cor 1 do Boss 2
#RGBBOSS23 = 0  ; RGB 3 da Cor 1 do Boss 2

#RGBBOSS31 = 0  ; RGB 1 da Cor 1 do Boss 3
#RGBBOSS32 = 0  ; RGB 2 da Cor 1 do Boss 3
#RGBBOSS33 = 12 ; RGB 3 da Cor 1 do Boss 3

#RGBBOSS41 = 12 ; RGB 1 da Cor 1 do Boss 4
#RGBBOSS42 = 2  ; RGB 2 da Cor 1 do Boss 4
#RGBBOSS43 = 0  ; RGB 3 da Cor 1 do Boss 4

#RGBBOSS51 = 4  ; RGB 1 da Cor 1 do Boss 5
#RGBBOSS52 = 4  ; RGB 2 da Cor 1 do Boss 5
#RGBBOSS53 = 12 ; RGB 3 da Cor 1 do Boss 5
...
; Vai buscar as Shapes de 8 cores em OCS/ECS
...
.movenave
  ...
  If nvinven=1 ; Se a Nave estiver invencivel alterna-lhe as cores
    If nvmc=1
      PalRGB #PAL,#CORNV1,#RGBNV21,#RGBNV22,#RGBNV23
      PalRGB #PAL,#CORNV2,#RGBNV11,#RGBNV12,#RGBNV13
      DisplayPalette #COPPERJ,#PAL
      nvmc=0
    Else
      PalRGB #PAL,#CORNV1,#RGBNV11,#RGBNV12,#RGBNV13
...
.criaexplosaoboss
  ...
  Select tipo
    Case 5
      PalRGB #PAL,#CORBOSS1,#RGBMAX,#RGBMAX,#RGBMAX
    Case 6
      PalRGB #PAL,#CORBOSS2,#RGBMAX,#RGBMAX,#RGBMAX
    Case 7
      PalRGB #PAL,#CORBOSS3,#RGBMAX,#RGBMAX,#RGBMAX
    Case 8
      PalRGB #PAL,#CORBOSS4,#RGBMAX,#RGBMAX,#RGBMAX
    Case 9
      PalRGB #PAL,#CORBOSS5,#RGBMAX,#RGBMAX,#RGBMAX
  End Select
...
.moveexplosaoboss
  ...
  If bossexp=0
    ...
    Select tipot
      Case 5
        PalRGB #PAL,#CORBOSS1,#RGBBOSS11,#RGBBOSS12,#RGBBOSS13
      Case 6
        PalRGB #PAL,#CORBOSS2,#RGBBOSS21,#RGBBOSS22,#RGBBOSS23
      Case 7
        PalRGB #PAL,#CORBOSS3,#RGBBOSS31,#RGBBOSS32,#RGBBOSS33
      Case 8
        PalRGB #PAL,#CORBOSS4,#RGBBOSS41,#RGBBOSS42,#RGBBOSS43
      Case 9
        PalRGB #PAL,#CORBOSS5,#RGBBOSS51,#RGBBOSS52,#RGBBOSS53
    End Select
